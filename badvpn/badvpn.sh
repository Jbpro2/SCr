...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/Jbpro2/SCr/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Jbpro2/SCr/main/badvpn/antcrashvpn.sh -o /dev/null
